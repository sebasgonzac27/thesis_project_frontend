...
export function FeedbackList({ onCreateNew, onSelectFeedback }: Readonly<FeedbackListProps>) {
  ...
  const loadFeedbacks = async () => {
    ...
    try {
      ...
      const sortedFeedbacks = [...feedbackWithDetails].sort((a, b) =>
    ...
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row md:justify-between items-center gap-y-4">
        <div className="flex flex-wrap gap-2 justify-center md:justify-start">
          ...
          >
            En Revisión
            <Badge variant="secondary" className="ml-2 bg-green-200">
          ...
          >
            Resueltos
            <Badge variant="secondary" className="ml-2 bg-pink-200">
