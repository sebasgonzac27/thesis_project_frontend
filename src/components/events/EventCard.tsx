...
import { eventTypeColors, EventWithDetails, Review } from '@/models';
import { formatDate } from './utils';
import { EventDescription } from './EventDescription';
import { createParticipation, deleteParticipation, getParticipation, getReview, getEventReviews, getUser } from '@/services';
            ...
            <>
              {!hasReviewed ? (
                ...
                <div className="text-center text-sm text-gray-500">
                  Ya has enviado una reseña para este evento
                </div>
              )}
            </>
          ) : view === 'any' ? (
              ...
              reviews.map((review: any) => (
                <div key={review.id} className="border rounded-lg p-4">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <p className="font-semibold">{review.author.profile.first_name} {review.author.profile.last_name}</p>
